...
1. [初始化椭圆曲线代码。](/blog/2018/06/bitcoin-src-comments-06.html#Init-ref)<br>
2. [初始化完整性检查。](/blog/2018/07/bitcoin-src-comments-07.html#InitSanityCheck-ref)<br>
3. [数据目录上锁。](/blog/2018/07/bitcoin-src-comments-07.html#DataDirLock-ref)<br>
4. [非 WIN32 环境，创建进程号文件。](/blog/2018/07/bitcoin-src-comments-07.html#CreatePidFile-ref)<br>
5. [处理调试日志文件。](/blog/2018/07/bitcoin-src-comments-07.html#ShrinkOrOpenDebugLogFile-ref)<br>
6. 记录相关初始化信息到日志输出。<br>
