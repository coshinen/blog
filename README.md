...
* 2020.04.01 [-] pages: ~~resume page~~ (merge)
* 2020.03.29 [-] blog page: ~~comments, profile~~ (home page); [+] blog page: archive
* 2020.03.26 [+] blog page: category, tag cloud
* 2020.03.24 [-] site: ~~Busuanzi analytics~~ (not compatible with Safari); pages: ~~donate page~~ (merge)
...
* 2019.09.07 [-] post: ~~{% highlight %} code {% endhighlight %}~~ (Jekyll Only); [+] post: ```code``` (markdown)
...
* 2018.08.28 [-] footer: ~~slogan~~; pages: ~~slogan page~~ (rename); [+] footer: quote; pages: quotes page
